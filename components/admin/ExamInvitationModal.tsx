                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1">
                          ...
                          {participant.teams?.team_name && (
                            <p className="text-xs text-gray-500">Team: {participant.teams.team_name} {participant.teams.team_code && `(${participant.teams.team_code})`}</p>
                          )}
                          <div className="mt-2 p-2 bg-gray-50 rounded border border-gray-200">
                            <p className="text-xs text-gray-500 mb-1">Exam Link:</p>
