-- Duplicate of supabase/migrations/20260406120000_import_batches.sql for manual Supabase SQL Editor runs
...
DROP POLICY IF EXISTS "Admins can manage import_batches" ON import_batches;
